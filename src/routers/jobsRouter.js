...
// POST /api/users/:userId/jobs/:jobId/takeScreenshot
/**
 * @openapi
 * /api/users/{userId}/jobs/{jobId}/takeScreenshot:
 *   post:
...
// POST /api/users/:userId/jobs/:jobId/parseJob
/**
 * @openapi
 * /api/users/{userId}/jobs/{jobId}/parseJob:
 *   post:
...
// POST /api/users/:userId/jobs/:jobId/match
/**
 * @openapi
 * /api/users/{userId}/jobs/{jobId}/match:
 *   post:
...
// POST /api/users/:userId/jobs/:jobId/improveResume
/**
 * @openapi
 * /api/users/{userId}/jobs/{jobId}/improveResume/{resumeId}:
 *   post:
